...
class TestHousingQuestionAsker(unittest.TestCase):
    ...
    def test_ask_additional_questions_basic(self) -> None:
        ...
        with patch('builtins.input', side_effect=['y', 'n', 'y']):
            ...
            self.assertEqual(result, {'at_least_21': True, 'honors': False, 'probation': True})
    ...
    def test_ask_additional_questions_reverse(self) -> None:
        ...
        with patch('builtins.input', side_effect=['n', 'y', 'y']):
            ...
            self.assertEqual(result, {'at_least_21': False, 'honors': True, 'probation': True})
    ...
    def test_ask_additional_questions_with_invalid_input(self) -> None:
        ...
        with patch('builtins.input', side_effect=['invalid', 'y', 'maybe', 'n', 'maybe', 'yes']):
            result = self.question_asker.ask_additional_questions()
